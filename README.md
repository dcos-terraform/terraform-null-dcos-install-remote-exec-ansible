...
| dcos\_download\_windows\_url | [DEPRECATED] Custom DC/OS windows download URL | string | `""` | no |
| dcos\_download\_windows\_url\_checksum | [DEPRECATED] Custom DC/OS windows download URL SHA256 Checksum. Empty string omits checking. | string | `""` | no |
